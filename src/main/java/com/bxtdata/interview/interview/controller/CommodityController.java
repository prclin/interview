...
public class CommodityController {
    ...
    public HashMap<String, Object> getBreakPriceUrls(@RequestParam("batchNo") @NotEmpty String batchNo, @RequestParam @NotEmpty String platform, @RequestParam(defaultValue = "10") Integer count) {
